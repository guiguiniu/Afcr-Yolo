...
if __name__ == '__main__':
    ...
    parser.add_argument('--t_weights', type=str, default=r'\runs\train\exp\weights\best.pt', help='initial tweights path')
    ...
    parser.add_argument('--distill', action='store_true', help='distillation training')

    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-tiny.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/coco128.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.p5-distillation.yaml', help='hyperparameters path')
